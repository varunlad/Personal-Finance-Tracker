...
export default function SummaryCards({
  ...
  return (
    <div className="ea-cards">
      ...
      <CategoryCard
        title="Credit Card"
        percent={catPct.creditCard}
        amount={fmtAmount(monthByCategory.creditCard)}
        barClass="creditCard"
        info="Payments made via your credit cards (billed spends)."
      />

      <CategoryCard
        title="EMIs"
        percent={catPct.emi}
        amount={fmtAmount(monthByCategory.emi)}
        barClass="emi"
        info="Equated Monthly Instalments (loans on home, phones, bikes, etc.)."
      />
